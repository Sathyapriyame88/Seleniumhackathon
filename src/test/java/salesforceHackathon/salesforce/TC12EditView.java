...
public class TC12EditView extends SalesforceUtility {
	...
	public static void main(String[] args) throws Exception{
		launchBrowser();
		gotosalesforceURL();
		 Map<String, String>  rowMap = readRowFromExcel(13);
		loginToSalesforce(rowMap.get("userName"), rowMap.get("Password"));
		editView(rowMap.get("NewViewName"));
		quitBrowser();
		
	}

	public static void editView(String newviewname) throws Exception{
		...
		se.selectByVisibleText(newviewname);
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("//input[@id='fname']")).sendKeys(newviewname);
